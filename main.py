...
values = range(1*60, 10*60, 1*60)  # From 60 to 600 in steps of 60
...
for value in values:
    ...
    for size in sizes:
        ...
        # Fixed: statistic() needs two arguments (hops, stat)
        # Based on original code that filtered df.hops == 0, we want hops=0
